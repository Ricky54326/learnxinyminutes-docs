...
contributors:
    ...
    - ["Árpád Goretity", "http://twitter.com/H2CO3\_iOS"]
...
```c
// Commenter une ligne - seuelement avavable avec C99 ou tard

/*
Comment plus lignes. Ça marche avec tous les versions.
*/

// Constants: #define <mot-clé> <valeur>
#define UNE_ANNEE 365

// On peut definer des constants avec les énumerations
// Terminez avec un point-virgule
enum jours {DIM = 1, LUN, MAR, MER, JEU, VEN, SAM};
// LUN est automatiquement 2, MAR est 3, ...


// Importez "headers" avec #include
// le header pour _tous_
#include <stdlib.h>
// pour I/O
#include <stdio.h>
// pour "strings"
...
// Les headers standards sont enclosés par <les chevrons>
...
// Il faut declarer un "prototype fonctionnel" avant main() au cas des fonctions
// sont implementées après main().
int somme(int x1, int x2); // prototype -- attention au point-virgule

// Votre programme commence avec main().
// main() doit retourne un int.
int main(void) {
  // print output using printf, for "print formatted"
  // %d is an integer, \n is a newline

  // Imprimez avec printf (de "print formatted" en anglais)
  // %d ç'est int, \n ç'est nouvelle ligne
  printf("%d\n", 0); // => "0" avec une nouvelle ligne
